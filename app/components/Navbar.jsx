...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-4 xl:px-[8%] py-4 flex items-center justify-between z-50 ${
      ...
      >
        ...
        <ul className="hidden md:flex items-center gap-6 lg:gap-8n rouded-full px-12 py-3 bg-white not-last:shadow-sm bg-capacity-100">
          <li>
            <a href="#top">Home</a>
          </li>
          <li>
